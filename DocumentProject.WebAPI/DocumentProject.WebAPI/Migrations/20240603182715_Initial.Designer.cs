...
namespace DocumentProject.WebAPI.Migrations
{
    ...
    [Migration("20240603182715_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DocumentProject.WebAPI.Data.Admin", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DocumentProject.WebAPI.Data.Application", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DocumentProject.WebAPI.Data.Organization", b =>
                {
                    ...
                    b.Property<Guid>("OwnerManagerId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DocumentProject.WebAPI.Data.Application", b =>
                {
                    b.HasOne("DocumentProject.WebAPI.Data.Member", "Member")
                        .WithMany("Applications")
                        .HasForeignKey("MemberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DocumentProject.WebAPI.Data.Organization", "Organization")
                        .WithMany("Applications")
            ...
            modelBuilder.Entity("DocumentProject.WebAPI.Data.Organization", b =>
                {
                    b.HasOne("DocumentProject.WebAPI.Data.Manager", "OwnerManager")
                        ...
                        .HasForeignKey("OwnerManagerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("OwnerManager");
                });
